...
import com.denovo.hbaseObserver.ElasticsearchBulkOperator;
 ...
 * @author liusinan
 * @version 1.0.0
 * @ClassName Hbase2EsObserver.java
 * @Description
 * @createTime 2020年07月21日 08:00:00
 */
public class Hbase2EsObserver extends BaseRegionObserver {
    private static final Log LOGGER = LogFactory.getLog(Hbase2EsObserver.class);
    ...
    private void loadEsClientInfo(CoprocessorEnvironment e) {
        ...
        // 192.168.1.1:9300-192.168.1.2:9300
        String esClientInfo = e.getConfiguration().get("esClientInfo", "localhost:9300");
